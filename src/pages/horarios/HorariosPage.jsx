  ...
  return (
    ...
    >
      ...
      <div className="mb-6 grid grid-cols-4 gap-4">
        ...
        <div className="rounded-lg bg-surface-container-highest p-5"><p className="mb-1 font-headline text-[10px] font-bold uppercase tracking-widest text-on-surface-variant">Asignaciones</p><p className="font-headline text-2xl font-black text-green-600">48</p></div>
      ...
      {activeTab === 'horarios' ? (
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 overflow-hidden rounded-xl border border-slate-200/50 bg-surface-container-lowest lg:col-span-7">
            <div className="flex items-center justify-between gap-3 border-b border-slate-100 p-5"><h3 className="flex shrink-0 items-center gap-2 font-headline text-xs font-extrabold tracking-[0.2em]"><span className="material-symbols-outlined text-sm">schedule</span> LISTADO DE HORARIOS</h3><div className="flex items-center gap-2"><FilterSelect value={scheduleType} onChange={(e) => setScheduleType(e.target.value)} minWidth="min-w-[7rem]"><option value="">Todos los tipos</option><option>Fijo</option><option>Flexible</option></FilterSelect><FilterSelect value={scheduleStatus} onChange={(e) => setScheduleStatus(e.target.value)} minWidth="min-w-[7rem]"><option value="">Todos los estados</option><option>Activo</option><option>Inactivo</option></FilterSelect><button type="button" onClick={() => { setScheduleType(''); setScheduleStatus('') }} className="flex items-center gap-1 rounded-md border border-outline-variant/30 px-3 py-1.5 text-xs font-bold text-on-surface-variant transition-colors hover:bg-surface-container-low"><span className="material-symbols-outlined text-sm">filter_alt_off</span></button></div></div>
            <div className="overflow-x-auto"><table className="w-full border-collapse text-left"><thead><tr className="bg-surface-container-low"><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">ID</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Nombre</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Tipo</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Estado</th></tr></thead><tbody className="divide-y divide-slate-100">{filteredSchedules.length ? filteredSchedules.map((item) => <tr key={item.id} onClick={() => setSelectedSchedule(item)} className="cursor-pointer transition-colors hover:bg-slate-50"><td className="px-5 py-3.5 font-mono text-sm font-bold text-primary">{item.id}</td><td className="px-5 py-3.5 text-sm font-semibold">{item.name}</td><td className="px-5 py-3.5"><TypePill variant={item.type === 'Flexible' ? 'primary' : 'default'}>{item.type}</TypePill></td><td className="px-5 py-3.5"><StatusPill>{item.status}</StatusPill></td></tr>) : <EmptyTableRow colSpan={4} onClear={() => { setScheduleType(''); setScheduleStatus('') }} />}</tbody></table></div>
      ...
      {activeTab === 'ciclos' ? (
        <div className="grid grid-cols-12 gap-6"><div className="col-span-12 overflow-hidden rounded-xl border border-slate-200/50 bg-surface-container-lowest lg:col-span-7"><div className="flex items-center justify-between gap-3 border-b border-slate-100 p-5"><h3 className="flex shrink-0 items-center gap-2 font-headline text-xs font-extrabold tracking-[0.2em]"><span className="material-symbols-outlined text-sm">autorenew</span> LISTADO DE CICLOS</h3><div className="flex items-center gap-2"><FilterSelect value={cycleStatus} onChange={(e) => setCycleStatus(e.target.value)}><option value="">Todos los estados</option><option>Activo</option><option>Inactivo</option></FilterSelect><button type="button" onClick={() => setCycleStatus('')} className="flex items-center gap-1 rounded-md border border-outline-variant/30 px-3 py-1.5 text-xs font-bold text-on-surface-variant transition-colors hover:bg-surface-container-low"><span className="material-symbols-outlined text-sm">filter_alt_off</span></button></div></div><div className="overflow-x-auto"><table className="w-full border-collapse text-left"><thead><tr className="bg-surface-container-low"><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">ID</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Nombre</th><th className="px-5 py-3.5 text-center text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Duración</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Estado</th></tr></thead><tbody className="divide-y divide-slate-100">{filteredCycles.length ? filteredCycles.map((item) => <tr key={item.id} onClick={() => setSelectedCycle(item)} className="cursor-pointer transition-colors hover:bg-slate-50"><td className="px-5 py-3.5 font-mono text-sm font-bold text-primary">{item.id}</td><td className="px-5 py-3.5 text-sm font-semibold">{item.name}</td><td className="px-5 py-3.5 text-center"><TypePill>{item.days} días</TypePill></td><td className="px-5 py-3.5"><StatusPill>{item.status}</StatusPill></td></tr>) : <EmptyTableRow colSpan={4} onClear={() => setCycleStatus('')} />}</tbody></table></div><div className="flex items-center justify-between border-t border-slate-100 px-5 py-3"><p className="text-xs text-on-surface-variant">Mostrando 3 ciclos</p><span className="px-2 text-xs font-bold text-on-surface-variant">1 / 1</span></div></div><div className="col-span-12 lg:col-span-5">{selectedCycle ? <CycleDetail item={selectedCycle} onEdit={() => setModal('editar-ciclo')} /> : <EmptyDetail title="Ningún ciclo seleccionado" />}</div></div>
      ) : null}

      {activeTab === 'asignaciones' ? (
        <div className="grid grid-cols-12 gap-6"><div className="col-span-12 overflow-hidden rounded-xl border border-slate-200/50 bg-surface-container-lowest lg:col-span-7"><div className="flex items-center justify-between gap-3 border-b border-slate-100 p-5"><h3 className="flex shrink-0 items-center gap-2 font-headline text-xs font-extrabold tracking-[0.2em]"><span className="material-symbols-outlined text-sm">person_pin</span> ASIGNACIONES</h3><div className="flex items-center gap-2"><FilterSelect value={assignmentType} onChange={(e) => setAssignmentType(e.target.value)} minWidth="min-w-[9rem]"><option value="">Todos los tipos</option><option value="horario">Horario fijo</option><option value="ciclo">Ciclo rotativo</option></FilterSelect><FilterSelect value={assignmentStatus} onChange={(e) => setAssignmentStatus(e.target.value)}><option value="">Todos los estados</option><option value="activa">Activa</option><option value="vencida">Vencida</option></FilterSelect><button type="button" onClick={() => { setAssignmentType(''); setAssignmentStatus('') }} className="rounded-md border border-outline-variant/30 p-1.5 text-on-surface-variant transition-colors hover:bg-surface-container-low"><span className="material-symbols-outlined text-sm">filter_alt_off</span></button></div></div><div className="overflow-x-auto"><table className="w-full border-collapse text-left"><thead><tr className="bg-surface-container-low"><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Legajo</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Empleado</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Tipo</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Horario / Ciclo</th><th className="px-5 py-3.5 text-[10px] font-bold uppercase tracking-wider text-on-surface-variant">Estado</th></tr></thead><tbody className="divide-y divide-slate-100">{filteredAssignments.length ? filteredAssignments.map((item) => <tr key={item.id} onClick={() => setSelectedAssignment(item)} className="cursor-pointer transition-colors hover:bg-slate-50"><td className="px-5 py-3.5 font-mono text-sm font-bold text-primary">{item.legajo}</td><td className="px-5 py-3.5"><div className="flex items-center gap-2"><div className={`flex h-7 w-7 items-center justify-center rounded-full text-[10px] font-bold ${item.avatarClass}`}>{item.initials}</div>{item.employeeRoute ? <Link to={item.employeeRoute} onClick={(event) => event.stopPropagation()} className="text-sm font-semibold hover:text-primary hover:underline">{item.employee}</Link> : <span className="text-sm font-semibold">{item.employee}</span>}</div></td><td className="px-5 py-3.5"><TypePill variant={item.type === 'ciclo' ? 'tertiary' : 'default'}>{item.typeLabel}</TypePill></td><td className="px-5 py-3.5 text-sm font-medium">{item.resource}</td><td className="px-5 py-3.5"><StatusPill>{item.status}</StatusPill></td></tr>) : <EmptyTableRow colSpan={5} onClear={() => { setAssignmentType(''); setAssignmentStatus('') }} />}</tbody></table></div><div className="flex items-center justify-between border-t border-slate-100 px-5 py-3"><p className="text-xs text-on-surface-variant">Mostrando 4 asignaciones</p><span className="px-2 text-xs font-bold text-on-surface-variant">1 / 1</span></div></div><div className="col-span-12 lg:col-span-5">{selectedAssignment ? <AssignmentDetail item={selectedAssignment} onEdit={() => setModal('editar-asignacion')} /> : <EmptyDetail title="Ninguna asignación seleccionada" />}</div></div>
      ) : null}
